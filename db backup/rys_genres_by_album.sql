...
--
-- Dumping data for table `genres_by_album`
--

LOCK TABLES `genres_by_album` WRITE;
/*!40000 ALTER TABLE `genres_by_album` DISABLE KEYS */;
/*!40000 ALTER TABLE `genres_by_album` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-06-01 19:54:00
